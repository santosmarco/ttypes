...
export class TUndefined extends TType<undefined, TUndefinedDef> {
  get _manifest() {
    return TManifest<undefined>()({ type: TParsedType.Undefined, literal: u.literalize(undefined), required: false })
  }
...
export class TVoid extends TType<void, TVoidDef> {
  get _manifest() {
    return TManifest<void>()({ type: TParsedType.Void, required: false })
  }
...
export class TNull extends TType<null, TNullDef> {
  get _manifest() {
    return TManifest<null>()({ type: TParsedType.Null, literal: u.literalize(null), nullable: true })
  }
